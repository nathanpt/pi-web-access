...
function normalizeProviderInput(value: unknown): SearchProvider | undefined {
	...
	if (normalized === "auto" || normalized === "priority" || normalized === "exa" || normalized === "perplexity" || normalized === "gemini" || normalized === "parallel" || normalized === "searxng" || normalized === "olostep" || normalized === "brave" || normalized === "tavily" || normalized === "openai" || normalized === "brightdata" || normalized === "firecrawl") {
		return normalized;
	}
	return "auto";
}
