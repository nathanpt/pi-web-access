...
// Imports the REAL ssrf-protection module (not a duplicated copy) so these act
// as true regression guards on the shipped code. Ports upstream PR #102
// (TianZuo555); retires the previous self-duplicated validateUrl test.
